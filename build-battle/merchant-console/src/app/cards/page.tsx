...
import { IssueCardForm } from "./issue-form"
...
export default function CardsPage() {
  ...
  return (
    <section aria-label="Cards">
      <div className="grid gap-6 px-4 py-6 sm:p-6 lg:grid-cols-[minmax(0,1fr)_22rem]">
        <div className="lg:order-2">
          <h2 className="text-sm font-medium text-gray-900 dark:text-gray-50">
            Issue a card
          </h2>
          <p className="mb-4 mt-1 text-sm text-gray-500">
            Virtual, single-merchant, and limited from the moment it exists.
          </p>
          <IssueCardForm
                  ...
                  <TableRow>
                    <TableCell colSpan={6} className="py-16 text-center">
                      ...
                      <p className="mt-1 text-gray-500">
                        Issue one with the form, and it will appear here.
                      </p>
                    </TableCell>
                  </TableRow>
                )}
